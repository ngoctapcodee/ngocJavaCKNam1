...
public class Login {
 ...
 private static String NAME_EXIST = "THIS NAME IS ALREADY USED. PLEASE TRY AGAIN";
 private static String SERVER_NOT_START = "TURN ON SERVER BEFORE START";
 private static String LOGIN_FAILED = "INCORRECT USERNAME OR PASSWORD. PLEASE TRY AGAIN";
 ...
 public void setVisible(boolean visible) {
  frameLoginForm.setVisible(visible);
 }
 ...
 private void initialize() {
  ...
  lblPassword.setBounds(47, 174, 106, 38);
  ...
  txtPassword.setBounds(128, 178, 366, 30);
  ...
  btnRegister.setBounds(128, 217, 169, 63);
  frameLoginForm.getContentPane().add(btnRegister);
